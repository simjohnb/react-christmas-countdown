...
```bash
git remote add encore encore://react-christmas-countdown-d9di
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/react-christmas-countdown-d9di/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/react-christmas-countdown-d9di/settings/integrations/github)
